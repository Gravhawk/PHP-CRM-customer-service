...
<html lang="en">
    <head>
        ...
        <!-- awesone fonts css-->
        <link href="index_style/css/font-awesome.css" rel="stylesheet" type="text/css">
        <!-- owl carousel css-->
        <link rel="stylesheet" href="index_style/owl-carousel/assets/owl.carousel.min.css" type="text/css">
        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="index_style/css/bootstrap.min.css">
        <!-- custom CSS -->
        <link rel="stylesheet" href="index_style/css/style.css">
            ...
            <button class="navbar-toggler" data-target="#my-nav" onclick="myFunction(this)" data-toggle="collapse"><span
                ...
                <div id="my-nav" class="collapse navbar-collapse">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <a href="customer_signin.php" class="btn btn-outline-dark my-2 my-sm-0 mr-3 text-uppercase">login</a>
                        <a href="customer_signup.php" class="btn btn-info my-2 my-sm-0 text-uppercase">signup</a>
                    </form>
                </div>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <a href="#"> Add your complaints <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                        <div class="col-md-6">
                            <div class="card"><img class="card-img-top img-fluid" src="index_style/images/Customer.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="cover">
                                <div class="card">
                                    <svg
                                        ...
                                        <image clip-path="url(#clip-path)" xlink:href="index_style/images/splash-4.jpg" width="100%"
                ...
                <div class="container-fluid gtco-features" id="about">
                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="card text-center">
                                                    <div class="oval"><img class="card-img-top" src="index_style/images/web-design.png" alt=""></div>
                                                    <div class="card-body">
                                                ...
                                                <div class="card text-center">
                                                    <div class="oval"><img class="card-img-top" src="index_style/images/marketing.png" alt=""></div>
                                                    <div class="card-body">
                                            ...
                                            <div class="col">
                                                <div class="card text-center">
                                                    <div class="oval"><img class="card-img-top" src="index_style/images/seo.png" alt=""></div>
                                                    <div class="card-body">
                                                ...
                                                <div class="card text-center">
                                                    <div class="oval"><img class="card-img-top" src="index_style/images/graphics-design.png" alt=""></div>
                                                    <div class="card-body">
                        ...
                        <div class="container-fluid gtco-numbers-block">
                            <div class="container">
                                <svg width="100%" viewBox="0 0 1600 400">
                                    ...
                                    <!-- xlink:href for modern browsers, src for IE8- -->
                                    <image  clip-path="url(#ctm)" xlink:href="index_style/images/word-map.png" height="800px" width="100%" class="svg__image">
                                    </image>
                                </svg>
                                <div class="row">
                                    <div class="col-3">
                        ...
                        <div class="container-fluid gtco-testimonials">
                            <div class="container">
                                ...
                                <div class="owl-carousel owl-carousel1 owl-theme">
                                    <div>
                                        <div class="card text-center"><img class="card-img-top" src="index_style/images/customer1.jpg" alt="">
                                            <div class="card-body">
                                                <h5>Lisa Gally <br/>
                                    ...
                                    <div>
                                        <div class="card text-center"><img class="card-img-top" src="index_style/images/customer2.jpg" alt="">
                                            <div class="card-body">
                                                <h5>Missy Limana<br/>
                                                <span> Project Manager </span></h5>
                                                <p class="card-text">“ Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
                                    ...
                                    <div>
                                        <div class="card text-center"><img class="card-img-top" src="index_style/images/customer3.jpg" alt="">
                                            <div class="card-body">
                                                <h5>Aana Brown<br/>
                                                <span> Project Manager </span></h5>
                                                <p class="card-text">“ Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="media col-md-6 col-lg-4">
                                        <div class="oval mr-4"><img class="align-self-start" src="index_style/images/quality-results.png" alt=""></div>
                                    ...
                                    <div class="media col-md-6 col-lg-4">
                                        <div class="oval mr-4"><img class="align-self-start" src="index_style/images/analytics.png" alt=""></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media col-md-6 col-lg-4">
                                        <div class="oval mr-4"><img class="align-self-start" src="index_style/images/affordable-pricing.png" alt=""></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media col-md-6 col-lg-4">
                                        <div class="oval mr-4"><img class="align-self-start" src="index_style/images/easy-to-use.png" alt=""></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media col-md-6 col-lg-4">
                                        <div class="oval mr-4"><img class="align-self-start" src="index_style/images/free-support.png" alt=""></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media col-md-6 col-lg-4">
                                        <div class="oval mr-4"><img class="align-self-start" src="index_style/images/effectively-increase.png" alt=""></div>
                                        <div class="media-body">
                        ...
                        <div class="container-fluid gtco-logo-area">
                            <div class="container">
                                <div class="row">
                                    <div class="col"><img src="index_style/images/logo1.png" class="img-fluid" alt=""></div>
                                    <div class="col"><img src="index_style/images/logo2.png" class="img-fluid" alt=""></div>
                                    <div class="col"><img src="index_style/images/logo3.png" class="img-fluid" alt=""></div>
                                    <div class="col"><img src="index_style/images/logo4.png" class="img-fluid" alt=""></div>
                                    <div class="col"><img src="index_style/images/logo5.png" class="img-fluid" alt=""></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <script src="index_style/js/jquery-3.3.1.slim.min.js"></script>
                        <script src="index_style/js/popper.min.js"></script>
                        <script src="index_style/js/bootstrap.min.js"></script>
                        <!-- owl carousel js-->
                        <script src="index_style/owl-carousel/owl.carousel.min.js"></script>
